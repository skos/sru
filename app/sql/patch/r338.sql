...
(
  ...
  CONSTRAINT services_user_id_fkey FOREIGN KEY (user_id)
...
(
  ...
  CONSTRAINT services_history_modified_by_fkey FOREIGN KEY (modified_by)
      REFERENCES admins (id) MATCH SIMPLE
      ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT services_history_serv_id_fkey FOREIGN KEY (serv_id)
      REFERENCES services (id) MATCH SIMPLE
      ON UPDATE CASCADE ON DELETE SET NULL,
  CONSTRAINT services_history_serv_type_id_fkey FOREIGN KEY (serv_type_id)
      REFERENCES services_type (id) MATCH SIMPLE
      ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT services_history_user_id_fkey FOREIGN KEY (user_id)
      REFERENCES users (id) MATCH SIMPLE
      ON UPDATE CASCADE ON DELETE CASCADE
)
WITH (OIDS=FALSE);
