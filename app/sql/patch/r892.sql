ALTER TABLE computers ADD COLUMN auto_deactivation boolean NOT NULL DEFAULT true;
ALTER TABLE computers_history ADD COLUMN auto_deactivation boolean NOT NULL DEFAULT true;
