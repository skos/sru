...
function generate() {
		...
		-b 1024 -w 542 -h 200 -e "${3} ${4}" -s end-1d -v B/s -t "${2} day" -l 0
		...
		"DEF:bytesavg=${data}/${1}.rrd:tcpbytes:AVERAGE" \
                'CDEF:bytesavgNorm=bytesavg,60,/' \
                'LINE1:bytesavgNorm#FF0000:transfer' \
                -b 1024 -E -w 542 -h 200 -e "${3} ${4}" -s end-7d -v B/s -t "${2} week" -l 0
		...
		"DEF:bytesavg=${data}/${1}.rrd:tcpbytes:AVERAGE" \
                ...
                -b 1024 -w 542 -h 200 -e "${3} ${4}" -s end-30d -v B/s -t "${2} month" -l 0
		...
		"DEF:bytesavg=${data}/${1}.rrd:tcpbytes:AVERAGE" \
                'CDEF:bytesavgNorm=bytesavg,60,/' \
                'AREA:bytesavgNorm#FF6666:transfer' \
                -b 1024 -w 542 -h 200 -e "${3} ${4}" -s end-1y -v B/s -t "${2} year" -l 0
}
