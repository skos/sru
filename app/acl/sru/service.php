...
extends UFlib_ClassWithService {
	...
	public function edit() {
		...
		$user->getFromSession();
		if ($user->servicesAvailable && !$user->banned && ($user->typeId < UFbean_Sru_User::DB_STUDENT_MAX || $user->typeId == UFbean_Sru_User::TYPE_TOURIST_INDIVIDUAL || $user->typeId == UFbean_Sru_User::TYPE_TOURIST_DIDACTICS || $user->typeId == UFbean_Sru_User::TYPE_ORGANIZATION || $user->typeId == UFbean_Sru_User::TYPE_EXADMIN)) {
			return true;
		}
		return false;
	}
