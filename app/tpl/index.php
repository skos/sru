...
<ul id="nav">
<li><a href="http://regulamin.ds.pg.gda.pl/">_("Regulamin")</a></li>
<li><a href="<?=UFURL_BASE;?>/sru/">_("Użytkownik")</a></li>
<li><a href="<?=UFURL_BASE;?>/admin/">_("SKOS")</a></li>
<li><a href="<?=UFURL_BASE;?>/walet/">_("Walet")</a></li>
</ul>
<div id="main">
<?=$d['body'];?>
</div><!-- main -->
